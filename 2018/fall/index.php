...
<tr>
<td> <img class="sem_image img-circle"  src="wang_square.jpg" alt="image">  </td>
 <td> 
 <strong> 
...
<td> <img class="sem_image img-circle"  src="giorgio_bornia.jpg" alt="image">  </td>
 ...
 <table class="sem_item">
<tr>
<td> <img class="sem_image img-circle"  src="lauria.jpg" alt="image">  </td>
 <td> 
 <strong> 
...
has been used to price different aged-related longevity swaps.
 ...
 $(document).ready(  //jQuery function
  ...
  <table class="sem_item">
<tr>
<td> <img class="sem_image img-circle"  src="hoang.jpg" alt="image">  </td>
 <td> 
 <strong> 
 ...
 $(document).ready(  //jQuery function
  ...
  <table class="sem_item">
<tr>
<td> <img class="sem_image img-circle"  src="long.jpg" alt="image">  </td>
 <td> 
 <strong> 
   Wednesday, October 3
 </strong>
 ...
 $(document).ready(  //jQuery function
  ...
  <table class="sem_item">
<tr>
<td> <img class="sem_image img-circle"  src="sun.jpg" alt="image">  </td>
 <td> 
 <strong> 
...
<br>
  ...
  <table class="sem_item">
<tr>
<td> <img class="sem_image img-circle"  src="rahman.jpg" alt="image">  </td>
 <td> 
 <strong> 
...
<!-- =========================== -->
  ...
  <table class="sem_item">
<tr>
<td> <img class="sem_image img-circle"  src="volchenkov.jpg" alt="image">  </td>
 <td> 
 <strong> 
